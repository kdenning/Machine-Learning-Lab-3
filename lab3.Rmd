...
#lasso4_fit_2 %>% select_best(metric = "rmse")

```
 
 10, since it was the default for tune_grid 
 
  + If this is different than the number of models of `lasso4_fit_1`, please explain why.

Because we didn't specify it , before we had the defoult gor grid_regular (default = 3), while tune_grid has a default of 10
